...
function collection({
    ...
    collection?: CollectionRequiredFields | null;
    url: Request["url"];
}): SeoConfig {
    return {
        ...
        media: {
            ...
            height: collectionData?.image?.height ?? undefined,
            width: collectionData?.image?.width ?? undefined,
            altText: collectionData?.image?.altText ?? undefined,
        },
        jsonLd: collectionData
            ? collectionJsonLd({ collection: collectionData, url })
            : undefined,
    };
}
