...
export function OrderSummary({
    ...
    const fallbackAmount = {
        amount: "0",
        currencyCode: order.totalPrice.currencyCode || "EUR", // FIXME: Don't hardcode EUR fallback.
    };
    ...
    return (
        <div className="ml-auto space-y-4">
            <div className="flex justify-between gap-4">
                ...
                <span>
                    <Money data={order.subtotal || fallbackAmount} />
                </span>
            </div>
            <div className="flex justify-between gap-4">
                <span>Tax</span>
                <span>
                    <Money data={order.totalTax || fallbackAmount} />
                </span>
            </div>
            <div className="flex justify-between gap-4">
                <span>Shipping</span>
                <span>
                    <Money data={order.totalShipping || fallbackAmount} />
                </span>
            </div>
            ...
            <div className="flex justify-between gap-4">
                ...
                <span className="text-xl">
                    <Money data={order.totalPrice || fallbackAmount} />
                </span>
            </div>
            <div className="flex justify-between gap-4">
