            ...
            case "POST": {
                ...
                try {
                    ...
                    if (createData?.customerAddressCreate?.userErrors?.length) {
                        throw new Error(
                            createData?.customerAddressCreate?.userErrors[0]
                                .message,
                        );
                    }
                    ...
                    return {
                        error: null,
                        createdAddress:
                            createData?.customerAddressCreate?.customerAddress,
                        defaultAddress,
                    };
                } catch (error: unknown) {
            ...
            case "PUT": {
                ...
                try {
                    ...
                    if (updateData?.customerAddressUpdate?.userErrors?.length) {
                        throw new Error(
                            updateData?.customerAddressUpdate?.userErrors[0]
                                .message,
                        );
                    }
            ...
            case "DELETE": {
                ...
                try {
                    ...
                    if (delateData?.customerAddressDelete?.userErrors?.length) {
                        throw new Error(
                            delateData?.customerAddressDelete?.userErrors[0]
                                .message,
                        );
                    }
