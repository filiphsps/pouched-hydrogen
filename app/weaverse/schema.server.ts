            ...
            inputs: [
                ...
                },
                {
                    ...
                    condition: (theme: Record<string, any>) =>
                        theme.pcardTitlePricesAlignment === "vertical",
                },
                {
                    type: "switch",
                    label: "Show vendor",
                ...
                },
                {
                    ...
                    defaultValue: true,
                    condition: (theme: Record<string, any>) =>
                        theme.pcardShowLowestPrice !== true,
                },
                {
                    type: "switch",
                ...
                },
                {
                    ...
                    placeholder: "Color",
                    condition: (theme: Record<string, any>) =>
                        theme.pcardShowOptionValues === true,
                },
                {
                    type: "range",
        ...
        },
        {
            ...
            inputs: [
                ...
                },
                {
                    ...
                    defaultValue:
                        "https://x.com/i/communities/1636383560197373952",
                },
                {
                    type: "text",
                    name: "socialLinkedIn",
                ...
                },
                {
                    ...
                    label: "Description",
                    defaultValue:
                        "News and inspiration in your inbox, every week.",
                },
                {
                    type: "text",
