...
export function ZoomModal({
    ...
    useEffect(() => {
        if (zoomMediaId !== previousMediaId) {
            ...
            if (currentMedia?.mediaContentType === "IMAGE") {
                ...
                const previousMedia = media.find(
                    (med) => med.id === previousMediaId,
                );
                const previousImageUrl =
                    previousMedia?.mediaContentType === "IMAGE"
                        ? (previousMedia as Media_MediaImage_Fragment).image
                              ?.url
                        : null;
    ...
    function scrollToMedia(id: string) {
        ...
        if (mediaElement && scrollAreaRef.current) {
            const isVisible = isVisibleInParent(
                mediaElement,
    ...
    useEffect(() => {
        ...
        if (open) {
            window.requestAnimationFrame(
                () => zoomMediaId && scrollToMedia(zoomMediaId),
            );
